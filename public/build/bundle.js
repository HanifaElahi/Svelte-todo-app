...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "My To-Do List";
    			t1 = space();
    			span = element("span");
    			t2 = text(/*completedItemCount*/ ctx[1]);
    			t3 = text("/");
    			t4 = text(/*itemCount*/ ctx[0]);
    			add_location(div0, file, 21, 2, 425);
    			add_location(span, file, 22, 2, 452);
    			attr_dev(div1, "class", "header svelte-1axq353");
    			add_location(div1, file, 20, 0, 402);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [itemCount, completedItemCount];
    }
    ...
    /* src\components\Item.svelte generated by Svelte v3.24.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "text-input svelte-1l1o5hu");
    			attr_dev(input0, "type", "text");
    			input0.readOnly = /*complete*/ ctx[1];
    			add_location(input0, file$1, 56, 2, 981);
    			attr_dev(input1, "class", "complete-checkbox svelte-1l1o5hu");
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file$1, 63, 2, 1183);
    			attr_dev(div, "class", "item svelte-1l1o5hu");
    			toggle_class(div, "complete", /*complete*/ ctx[1]);
    			add_location(div, file$1, 55, 0, 913);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Item extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { id: 4, text: 0, complete: 1 });
    ...
    /* src\components\NewItem.svelte generated by Svelte v3.24.1 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-46ou57");
    			add_location(input, file$2, 35, 0, 612);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "list-status svelte-1gmcp39");
    			add_location(p, file$3, 78, 4, 1567);
    		},
    		m: function mount(target, anchor) {
    ...
    // (76:2) {#each itemsSorted as item (item)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(76:2) {#each itemsSorted as item (item)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "list svelte-1gmcp39");
    			add_location(div, file$3, 73, 0, 1383);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*itemsSorted, handleUpdate, handleDelete*/ 13) {
    				const each_value = /*itemsSorted*/ ctx[0];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function handleNewItem({ detail: text }) {
    		set_store_value(items, $items = [{ id: v4(), text, complete: false }, ...$items]);
    		TodoApi.save($items);
    	}
     ...
     */
    	function handleDelete({ detail: id }) {
    		set_store_value(items, $items = $items.filter(item => item.id !== id));
    		TodoApi.save($items);
    	}
    	...
    	onMount(async () => {
    		set_store_value(items, $items = await TodoApi.getAll());
    	});
    	...
    	return [itemsSorted, handleNewItem, handleUpdate, handleDelete];
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "container svelte-10598cd");
    			add_location(div, file$4, 18, 0, 326);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
